...
Page({
  ...
  onLoad(options){
    this.setData({
      flag_list:false,
      Course:app.courseTemp[options.index]
    })
    this.setData({
      name:this.data.Course.name,
      professorName:this.data.Course.professorName,
      startWeek:this.data.Course.startWeek,
      endWeek:this.data.Course.endWeek,
      period:this.data.Course.period
    })
    var str = this.data.Course.classroom.split("-")
    console.log()
    this.setData({
      location:str[0],
      classroomNo:str[1]
  ...
  confirm_location(){
    console.log(this.data.temp_location)
    this.setData({
  ...
  confirm(){
    ...
    wx.uploadFile({
      url: 'https://nicklorry.top:8090/supervisor/base/course/update',
      filePath: tempFiles,
      name: 'studentList',
      header:{
  ...
  delete(){
    wx.request({
      url: 'https://nicklorry.top:8090/supervisor/base/course/delete',
      data: {
